...
spawnOrFail("sam", [
  ...
  `${bucket}`,
  "--template-file",
  "templates/RecordingDemoCloudformationTemplate.yaml",
...
const ecsClusterName = spawnOrFail("aws", [
  "cloudformation",
  "describe-stacks",
  "--stack-name",
  `${stack}`,
...
const autoScalingGroupName = spawnOrFail("aws", [
  "cloudformation",
  "describe-stacks",
  "--stack-name",
  `${stack}`,
  "--query",
  "Stacks[0].Outputs[2].OutputValue",
  "--output",
  "text",
  "--region",
  `${region}`,
...
const autoScalingGroupInstances =
  asg.AutoScalingGroups && asg.AutoScalingGroups[0].Instances;
const autoScalingGroupArn =
  asg.AutoScalingGroups && asg.AutoScalingGroups[0].AutoScalingGroupARN;
const autoScalingGroupCapacityProviderName =
  autoScalingGroupName + "CapacityProvider";
var instanceIds = [];
...
spawnOrFail("aws", [
  ...
  `${JSON.stringify(defaultCapacityProvider)}`,
]);
